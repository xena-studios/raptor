...
> **Status:** early development. Phase 0 (foundations: repo, codegen, CI, signed releases) is complete; Phase 1 (Wings core) is next. Nothing here is usable yet. See the [roadmap](docs/ROADMAP.md).
